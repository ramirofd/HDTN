#ifndef HILINK_TCP_OUTDUCT_H
#define HILINK_TCP_OUTDUCT_H 1
...
public:
    OUTDUCT_MANAGER_LIB_EXPORT HilinkTcpOutduct(const outduct_element_config_t & outductConfig, const uint64_t outductUuid);
    OUTDUCT_MANAGER_LIB_EXPORT virtual ~HilinkTcpOutduct() override;
